...
As a authenticateduser, I want to identify myself as and pay for a $350 company sponsorship, so that I can easily become a sponsor at this level without having to interface with the product personnel to get a sponsorship.
...
As a sponsor, I want to link the product attendees to my sponsorship page, so that I can show off our level of attendance.
As a authenticateduser, I want to update my user profile, so that I can connect with other Drupalists at the product.
As a anonymoususer, I want to sign up for the product newsletter, so that I can stay up to date with the latest communications about the product.
...
As a administrator, I want to create blog posts, so that I can share the latest information about the product with the public.
As a anonymoususer, I want to read the blog, so that I can stay informed about all the latest happenings with the product.
...
As a anonymoususer, I want to learn about posting jobs as a sponsor and contact the sponsorship person, so that I have the opportunty to post my job listing on the product site.
...
As a anonymoususer, I want to see the final list of sessions approved, so that I can see what's going on at the product .
...
As a anonymoususer, I want to register to speak at the product, so that I submit a session.
As a authenticateduser, I want to submit a session at the product, so that I can get my session evaluated.
