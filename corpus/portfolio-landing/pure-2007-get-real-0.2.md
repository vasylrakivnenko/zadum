...
The software described in this document is the  website
...
The scope of the product website is limited to attracting and encouraging
...
testing of the product website.
...
The scope of the product website is to provide a high school teen friendly set
...
career with the right “push” from information on the product site.
The goal of the product is to encourage more Oregon students to choose
...
decision to pursue a career in CS. Benefits for using the site should include:

Personal and Career information from a broad spectrum of CS
professionals
CS course and other information from the product campuses
Timely and up to date information that encourages readers to return
to the site, may include Q  amp; A
...
Adhere to CSS and other style conventions established in the product version 1.
...
This product is an update of the existing the product web site version 1. The new
site will be version 2. A future version 3 may be needed to incorporate ideas
learned from version 2.

## Produce Features

Major features of the product website include the following pages/subsections:
...
High School Courses Search for additional information
...
interviewed to gain their feedback on version 1 of the product site. Common
themes emerged in the need to change/update overall site graphic design and
real people. Students who are not generally interested in CS, suggested graphic
...
comparison chart again scored positive marks. Changes to version 2 should include design changes to all existing pages to
shorten up paragraphs and add bullets and charts where possible to accommodate faster page reading and shorter reader attention span. One
example used on the engineergirl.org site uses an interactive table menu for
more detailed information, leaving the main pages short and to the point. "Identify the various user classes that you anticipate will use this product.
...
the product site runs as an extension of the product site e.g. ~the product.the product.edu~
Being part of the product domain will maximize Google and other search engine
...
## Example video “real people” profiles
...
## Women in Computer Science (existing with new name)
...
## Other resources for women in computer science

WICS UO, www.cs.uoregon.edu/groups/wics/
www.cis.upenn.edu/acg/wicarch.html this site lists a resource for those
wishing to contact women in computer architecture. the product might use a
...
## I’m Looking For… (existing)

A list of focused questions and answers with links inside the product site.
topics include: money, people, and colleges.

## Articles (existing)

A list of articles outside the product site including “50 best jobs in America,
Dream Jobs 2007, etc.

## High School Courses (new)
...
pointers to curricula recommendations from the product campuses and other
...
## Search for additional information (new)

At least two kinds of searches are needed, 1) internal search of the product
site, and 2) external search of CS related outside sites such as the product campuses,
articles on CS etc. Google, for example provides tools for internal and external
searches. the product prototype index page
~the product.the product.edu/protoindex.html has examples of various search engines.
...
the product site should work and be tested against IE, Firefox and Netscape.
...
the product site should be hosted on a server that can provide adequate
response time. High school students tend to have short attentions spans, so a
slow server would not be satisfactory for this application. The current the product
(www.the product.edu) site is a good example of rapid response time.

## Security Requirements

Copyright and other security measures for the product should be the same as the
the product site.
...
conventions used on the product site. "Specify any additional quality characteristics for the product that will be
...
## the product Version 3 Suggestions

## Knowledge base

Appendix A: Glossary
Appendix B: Analysis Models. Optionally, include any pertinent analysis models, such as data flow
diagrams, class diagrams, state-transition diagrams, or entity-relationship
diagrams.
Appendix C: Issues List. This is a dynamic list of the open requirements issues that remain to be
