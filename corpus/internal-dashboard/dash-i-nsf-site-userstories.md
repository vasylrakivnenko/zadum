...
As a developer, I want to have the subdomain beta.the product.gov be set up, so that I can deploy a beta site to it.
As a stakeholder, I want to have a decision on whether or not the blog aggregator may work for beta, and if not what will.
As the product employee, I want to understand the process of switching the cloud.gov hosting plan over from prototype to FISMA low.
...
As a team member, I want to meet with DIS / cloud.gov, so that I can determine the requirements for the beta.the product.gov ATO.
...
As the product administrator, I want to shadow the CMS implementation, so that I can learn as the prototype is developed further.
As a team member, I want to have an updated acquisitions roadmap, so that I can plan accordingly.
As the product employee, I want to have an updated roadmap document, so that I can see prioritized areas to focus on for the next few months and beyond.
...
As the product employee, I want to narrow down the universe of CMS options and identify/prioritize key considerations for getting to the next step.
As the product employee, I want to have a final workshop to identify key lessons and features for the content management system decision.
...
As the product employee, I want to understand work performed, so that I can understand when and what I can use later.
...
As the product employee, I want to have high-level strategy recommendations to implement in conjunction with the new CMS.
As the product employee, I want to have editorial-planning recommendations, so that I can understand how they might impact an eventual CMS / future web presence.
As the product employee, I want to know how brand guidelines are developed and maintained, so that I can incorporate them throughout the project.
As a web recruiter manager, I want to confirm the recruiter is set up and working properly on Science360.gov.
As the product employee, I want to know how visual design directions were developed, so that I can make better design decisions in the future.
As a team member, I want to know what the first hypothesis is, so that I can start developing a prototype to test.
As a content designer, I want to develop a better understanding of the product's content types and editorial plan, so that I can make more informed recommendations going forward.
...
As the product employee, I want to schedule regular in-person check-ins, so that we can continue to communicate the goals of the project with our stakeholders.
...
As the product person interested in attending user interviews, I want to know when they are scheduled and the type of user that will be interviewed.
As the product member of the team, I want to have a place where I can access all the related reports and documentation, so that I can refer to it easily now and in the future.
As a team member, I want to know when the mid-point checkin is and what will be covered, so that I can plan accordingly.
As the product employee, I want to join Github, so that I can participate in the issues as assigned.
As the product employee, I want to learn about how Github is used, so that I can participate in the issues as assigned.
As a user researcher, I want to begin identifying interview participants, so that I can understand what educators and science influencers need from a future the product.gov website.
As a VisualDesigner, I want to concept different styles for the product.gov website, so that we can discuss different design concepts with stakeholders.
...
As a VisualDesigner, I want to create a moodboard to aid with visual design concepts for the product.gov website, so that we can discuss different design concepts with stakeholders.
As a workshop attendee, I want to see a summary on major findings from the event.
As a user researcher, I want to make sure the correct the product people are invited to user interviews, so that they can observe the interviews and make recommendations accordingly.
...
As a VisualDesigner, I want to demonstrate the value of visual design to the product project team, so that visual design is an integral part of a redesign.
...
As the product employee, I want to see how the user recruitment form looks and behaves on a sample page, so that I can understand the impact the recruitment will have on the product page.
...
As a user researcher, I want to conduct a user definition workshop with the product, so that I can better prepare them and the team for future research work.
As the product employee, I want to know where the initial in-person meeting will be, so that I can plan on attending.
