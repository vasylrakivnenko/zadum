...
As a Researcher, I want an integration with  so that I can validate my data upon ingest to the service.
...
As a developer, I would like to create a web socket protocol for the product data tools, so that I can easily use data packages with additional data analysis tools.
