...
As a researcher, I want to import metadata that I captured with a metadata tool, so that I do not have to capture it again in the product.
...
As a PI, I want to record information about my the product, so that an Ethics Committee can review this for compliance with ethical standards.
As a legalofficer, I want to know about data sensitivity, so that I can establish sharing options.
As a data librarian, I want to extract pointers from the product to metadata held in other systems, so that I can import this metadata into a data catalogue.
...
As a research head, I want to access to the persistent identifiers of datasets provided in the product, so that I can check that the product has been implemented.
As a funder, I want to be able to read the costs for data management from the product, so that I can check whether our policies work as intended.
As a researcher, I want the product to prepopulate information that I have already entered in other institutional systems, so that I do not have to re-enter information ensuring the product contains accurate and standardized information.
...
As a stakeholder, I want to know who is responsible for the product, so that I can ask them about further details.
...
As a data librarian, I want to import administrative information regarding a project into the product, so that I can prepopulate the product.
...
As a researcher, I want to record research publications in the institutional repository or CRIS with the product records, so that I can generate reports of research output resulting from a project.
As a researcher, I want to link research publications in the institutional repository or CRIS with the product records, so that I can generate reports of research output resulting from a project.
...
As a funder, I want to be able to check all the repositories mentioned in the product, so that I can verify whether the project has followed our funding rules.
...
As a data manager, I want to know whether the product was approved, so that I can proceed with the required next steps.